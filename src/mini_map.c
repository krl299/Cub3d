...
/*   Updated: 2023/10/12 15:30:13 by mandriic         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char **temp_map()
{
	...
	map_m[i++] = "100000000000100000000001";
	map_m[i++] = "100000000000000010000001";
	map_m[i++] = "100000000000000000000001";
	map_m[i++] = "100101001000110010001001";
	map_m[i++] = "100000000000110000000001";
	map_m[i++] = "100000000000000000000001";
	map_m[i++] = "100000100000N00000001001";
	map_m[i++] = "100000000000000000000001";
	map_m[i++] = "100010000000000000000001";
	map_m[i++] = "100000000000010010000001";
	map_m[i++] = "101000000010000000000001";
	map_m[i++] = "100000010000000000000001";
	map_m[i++] = "100000000000000000000001";
	map_m[i++] = "111111111111111111111111";
		map_m[i] = NULL;
